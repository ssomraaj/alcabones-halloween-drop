						...
						<section className="section" id="about">
							<div>
								...
								<p>
									...
									<br />
									<br />
									Every time a newly minted NFT is sold on our marketplace, 10% of the sale value of
									the NFT is awarded to BollyCoin holders as discounts in the form of BollyCredits
									which can be used to purchase NFTs on our platform when it goes live.
									<br />
									<br />
